...
DimPlot(pbmc, reduction = "tsne", label =  TRUE, pt.size = 1, label.size = 6, repel = TRUE, cols = pbmc_colors) + plotTheme()
# ggsave("adult_allClusters_tSNE.png", path=exportDir, width = 140*2, height = 105*2, units = "mm")

DimPlot(pbmc, reduction = "umap", label = TRUE, pt.size = 1, label.size = 6, repel = TRUE, cols = pbmc_colors) + plotTheme()
# ggsave("adult_allClusters_UMAP.png", path=exportDir, width = 140*2, height = 105*2, units = "mm")
...
DimPlot(photo_larval, reduction = "tsne", label = TRUE, pt.size = 1, label.size = 6, cols=Photol_colors) +plotTheme()
...
# photo_larval = readRDS(file = "./photo_AdultAll.rds")
# # reload larval photoreceptors
# photo_larval = readRDS(file = "./photo_LarvalReAnalyzed.rds")
# -------------------------------------------------------------------
# check labels
levels(Idents(photo_larval))
...
ps = DimPlot(photoDev, reduction = "tsne", label=FALSE, repel=TRUE,pt.size = 1, cols=prcolors) +plotTheme()
ps
# ggsave(ps, file="photoDev_tSNE.png", path=exportDir, width = 140*2, height = 105*2, units = "mm")
